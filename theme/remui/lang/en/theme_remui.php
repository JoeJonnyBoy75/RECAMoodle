...
/* Dashboard Settings*/
$string['dashboardsetting'] = 'Dashboard Settings';
$string['olddashboard'] = 'You have old RemUI Block plugin installed in your system. To avail new features and settings please update your RemUI Block plugin to latest version.';
...
$string['coursedescimage'] = 'General Section Image Settings';
$string['coursedescimagedesc'] = 'If enabled, General section description background image will be fetched from course summary description ( By default first Image ) otherwise it will be fetched from Course summary files.';
...
$string['migratormessge'] = '<p>Welcome to brand new design of Edwiser Remui\'s home page. We found that you have older homepage settings. Do you like to migrate those settings?</p><p><strong>Migrate</strong> - New blocks will be created from older settings.</br><strong>Cancel</strong>- You can create frontpage manually and this message will not appear again.</p>';
...
// Capability String
$string['remui:editfrontpage'] = 'Edit Frontpage';

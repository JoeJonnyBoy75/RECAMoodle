...
/**
 * Creates a navbar for remui that allows easy control of the navbar items.
 *
 * @package    theme_remui
...
class remuinavbar implements \renderable {
    ...
    public function __construct(\moodle_page $page) {
        ...
        $this->prepare_nodes_for_remui();
    }

    /**
     * Prepares the navigation nodes for use with remui.
     */
    protected function prepare_nodes_for_remui(): void {
        global $PAGE;
    ...
    /**
     * Get all the remuinavbaritem elements.
     *
     * @return remuinavbaritem[] remui navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this remui navbar
     */
    ...
    /**
     * Remove a remuinavbaritem from the remui navbar.
     *
     * @param  string|int $itemkey An identifier for the remuinavbaritem
     * @param  int|null $itemtype An additional type identifier for the remuinavbaritem (optional)
     */
    ...
    /**
     * Removes the action from the last item of the remuinavbaritem.
     */

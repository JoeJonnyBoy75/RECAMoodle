...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_remui/drawers:show}
     * @property {String} drawerShown See {@link event:theme_remui/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_remui/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_remui/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_remui/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_remui/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_remui/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_remui/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_remui/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_remui/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_remui/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_remui/drawers:hidden',
    };
     ...
     * @returns {module:theme_remui/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_remui/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_remui/drawers:close');
     ...
     *
     * @param {module:theme_remui/drawers} comparisonInstance
     */

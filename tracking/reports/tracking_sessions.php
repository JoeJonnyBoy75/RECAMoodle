...
$result = $DB->get_records_sql('SELECT te.id, te.occurred, te.event, te.user_id, te.course_id, te.coursemodule_id, u.username, u.firstname, u.lastname, u.email, c.fullname AS course_name, sc.name AS module_name
...
<tr>
        <td><a href="tracking_session.php?id=<?php echo $r->id; ?>"><?php echo date("Y-m-d H:i:s", $r->occurred / 1000); ?></a></td>
